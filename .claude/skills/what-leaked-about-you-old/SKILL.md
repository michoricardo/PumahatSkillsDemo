---
name: what-leaked-about-you-old
description: >-
  SNAPSHOT for comparison only: the original what-leaked-about-you skill, before the scope
  gate and the selector-variants/pivot-planning section were added. Use only when explicitly
  asked to demo or diff the pre-modification version. Prefer what-leaked-about-you for real work.
